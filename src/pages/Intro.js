    ...
    <Primitives.Wizard>
      <IntroMain>
        ...
        <Primitives.Paragraphs.Lead>
          Denne veiviseren skal hjelpe deg som skal føre tilsyn med hvordan en byggevare brukes i et konkret byggeprosjekt. Du velger ut det produktet du skal undersøke og bestemmer deg for hvilke deler av produktet du skal føre tilsyn med. Svar på veiviseren ut ifra det. Eksempel: produkt vinduer og tilsyn med brann.
        </Primitives.Paragraphs.Lead>
        <Primitives.Paragraphs.P>
          Ved å svare på en rekke spørsmål får du svar på hva som kreves av dokumentasjon og hva som eventuelt mangler. Du bestemmer selv hvor “dypt” du vil gå i tilsynet, og hvilke deler av produktet du vil føre tilsyn med. Du må ikke svare på alt om alt.
        </Primitives.Paragraphs.P>
        <Primitives.Paragraphs.P>
          I veiviseren finner du 20 produkter. Ulike produkter har ulike krav til produktdokumentasjon. Dette henger blant annet sammen med om produktet er CE-merket eller ikke. Du vil derfor få ulike svaralternativer basert på hvilket produkt du velger.
        </Primitives.Paragraphs.P>
        <section>
          <div>
